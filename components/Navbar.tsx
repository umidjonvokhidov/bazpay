...
const Navbar = () => {
  ...
  return (
    <nav className="height-20 relative flex w-full items-center justify-between px-20 py-6 max-lg:px-10 max-md:px-6">
      <Link href="/">
        <Image
      ...
      <div className="bg-primary-200 nav-menu absolute top-[-100%] left-[-100%] hidden w-full flex-col items-center justify-center gap-y-10 overflow-hidden px-8 py-10 max-md:flex">
